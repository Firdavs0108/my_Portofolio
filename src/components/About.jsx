			...
			<div className={"About"} id="About">
				...
				<div className="About__content">
					<div className="About__textWrapper">
						<h2>Hello,</h2>
						<h3>
							My name is Firdavs. I am 22-years-old,young and passionate
							web-developer who is learning and trying hard to pursuade his
							dreams.
						</h3>
						<h3>
							Currently I am the last year student of Gachon Universtiy. I am a double major student, IT and GBA. However, I chose and
